...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "FEM",
    featured: false,
    tech: ["React", "Tailwind CSS 4", "Vite", "Props", "State Lifting", "Conditional Rendering"],
  },
  {
    id: 12,
    ...
    category: "FEM",
    featured: false,
    tech: ["React", "Tailwind CSS 4", "Vite", "useState", "useEffect", "Advice Slip API"],
  },
  {
    id: 13,
    ...
    category: "FEM",
    featured: false,
    tech: ["React", "Tailwind CSS 4", "Vite", "useRef", "useState", "useEffect", "Dark Mode"],
  },
  {
    id: 14,
    ...
    category: "CS50W",
    featured: true,
    tech: ["Django", "JavaScript", "SCSS", "Mapbox GL JS", "Open-Meteo", "Responsive Design"],
  },
  {
    id: 15,
    ...
    category: "CS50W",
    featured: false,
    tech: ["Django", "JavaScript", "Bootstrap 5", "Pagination", "Authentication"],
  },
  {
    id: 16,
    ...
    category: "Freelance",
    featured: true,
    tech: ["Python", "Flask", "Bootstrap 5", "Cloudinary", "SendGrid", "Heroku"],
  },
  {
    id: 21,
  ...
  },
  {
    ...
    category: "Professional",
    featured: true,
    tech: ["Django", "React", "PostgreSQL", "Azure", "JWT", "Django REST Framework"],
  },
];
